...
class Layout2f extends Component{
    ...
    render(){
                  ...
                  <div class="container-fluid ">
                   ...
                   <div class="row rstl">
                       ...
                       <div class="col-sm">
                           ...
                           <Link to="/layout2">{/*Image Button for layout change4 */}
        ...
        return(
            <div class="container-fluid">{/*This is for full screen mode of layout2 */}
                  ...
                  <div class="row  no-gutter">
                    ...
                    <div class="col-9">
                       ...
                       {/*<img src={vsi} class="broadimg2f"></img>*/}

                        <div id="full-screen-video" class="broadimg2f">
                       ...
                       <p class="l2fbdtxt">LIVE BROADCAST</p>

                    </div>

                    <div class="col-3">

                         <img src={ptcps} class="rightimg12f"></img>

                         <img src={ptcps} class="rightimg22f"></img>
                  ...
                  <div class="row no-gutter">
                    ...
                    <div class="col-3">
                      ...
                      <img src={ptcps} class="vid2f1"></img>

                    </div>

                    <div class="col-3">

                      <img src={ptcps} class="vid2f2"></img>

                    </div>

                    <div class="col-3">

                      <img src={ptcps} class="vid2f3"></img>

                    </div>

                    <div class="col-3">

                      <img src={ptcps} class="vid2f4"></img>
                  ...
                  <OverlayTrigger trigger="focus"  placement="top" overlay={popover}>
                        <button class="l2fbnsl"><img src={clbutton} alt="Loading..." class="bnimgsl"></img></button>
                  </OverlayTrigger>
